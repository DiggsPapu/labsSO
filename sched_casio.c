...
{ 
	...
	//char msg 
	char msg[CASIO_MSG_SIZE];
	snprintf(msg, CASIO_MSG_SIZE, "enqueue task casio: %d:%d:%llu", p->casio_id, p->pid, t->absolute_deadline);
...
{ 
	...
	//char msg 
	char msg[CASIO_MSG_SIZE];
	snprintf(msg, CASIO_MSG_SIZE, "dequeue task casio: %d:%d:%llu", t->task->casio_id, t->task->pid, t->absolute_deadline);
